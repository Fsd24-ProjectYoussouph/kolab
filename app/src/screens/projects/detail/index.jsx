      ...
      <section className="bg-app p-4 rounded-lg">
        <div className="flex items-center lg:justify-between flex-col sm:flex-row gap-2">
          ...
          <div className="space-y-1 shrink-0 sm:w-1/4 w-full ">
            <p className="text-xxs text-white">Deadline</p>
            <div>
              <div className="relative">
                <CalendarIcon
                  className="w-4 h-4 text-white absolute top-1/2 -translate-y-1/2 left-2.5 z-10"
                  noModal="true"
                />
                <input
                  type="date"
                  ...
                  className="pl-10 bg-app-maroon text-xs rounded-md w-full text-whitering-1 ring-transparent hover:ring-details-secondary transition-colors border-none cursor-pointer placeholder:text-details-link pr-10"
