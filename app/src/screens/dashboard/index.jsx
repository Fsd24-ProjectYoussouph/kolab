  ...
  return (
    <>
      <section className="space-y-6 flex flex-col flex-1">
        <div className="grid lg:grid-cols-12 4xl:grid-cols-[repeat(18,minmax(0,1fr))] bg-app rounded-2xl flex-1">
          ...
          />
            <div className="absolute top-5 left-7">
              ...
              <h1 className="text-4xl font-bold text-white">{t("hello")} !</h1>
          ...
          <div className="lg:col-span-9 4xl:col-[span_16_/_span_16] p-4 space-y-2 overflow-hidden">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center flex-col lg:flex-row gap-2 w-full lg:w-auto">
                <p className="font-bold text-white">{t("tasks")}</p>
                <Select
                  prefix={t("status")}
              ...
              <button
                ...
                className="py-2 px-4 rounded-[10px] bg-app-button font-bold text-white flex items-center justify-center gap-x-2 text-sm w-full lg:w-auto"
              >
                <PlusIcon />
                {t("task.new")}
              </button>
              ...
              <div className=" w-full h-full flex justify-center items-center flex-col">
                <div>
                  <span className=" text-details-secondary text-sm  ">
                    Vous n’avez pas encore de tâche assignée :{" "}
                  </span>
                  <span
                    onClick={() => {
                      setTaskSelected({});
